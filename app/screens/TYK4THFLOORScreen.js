...
const TYK4THFLOORScreen = ({ route, navigation }) => {
  ...
  const mapNodes = {
    ...
    LOP10: { x: 0.562, y: 0.81 },
    LOP11: { x: 0.515, y: 0.833 },
    LOP12: { x: 0.465, y: 0.858 },
    LOP13: { x: 0.42, y: 0.88 },
    LOP14: { x: 0.375, y: 0.9 },
    LOP15: { x: 0.324, y: 0.925 },

    LOP16: { x: 0.575, y: 0.828 },
    LOP17: { x: 0.605, y: 0.843 },
    LOP18: { x: 0.41, y: 0.906 },
    LOP19: { x: 0.363, y: 0.929 },
    LOP20: { x: 0.379, y: 0.936 },
    LOP21: { x: 0.41, y: 0.92 },
    LOP22: { x: 0.395, y: 0.942 },
    LOP23: { x: 0.442, y: 0.919 },
    ...
    LRP8: { x: 0.59, y: 0.81 },
    LRP9: { x: 0.407, y: 0.958 },
    LRP10: { x: 0.453, y: 0.937 },
    LRP11: { x: 0.5, y: 0.915 },
    LRP12: { x: 0.543, y: 0.895 },
    LRP13: { x: 0.59, y: 0.873 },
    LRP14: { x: 0.63, y: 0.853 },
    ...
    MRP17: { x: 0.425, y: 0.355 },
    MRP18: { x: 0.48, y: 0.355 },
    MRP19: { x: 0.635, y: 0.717 },
    MRP20: { x: 0.635, y: 0.754 },
    MRP21: { x: 0.665, y: 0.729 },
    MRP22: { x: 0.665, y: 0.753 },
    ...
    URP17: { x: 0.63, y: 0.056 },
    URP18: { x: 0.63, y: 0.09 },
    URP19: { x: 0.63, y: 0.122 },
    URP20: { x: 0.63, y: 0.156 },
    URP21: { x: 0.63, y: 0.189 },
    URP22: { x: 0.63, y: 0.225 },
    URP23: { x: 0.63, y: 0.255 },
    URP24: { x: 0.63, y: 0.291 },
    URP25: { x: 0.63, y: 0.319 },
    URP26: { x: 0.63, y: 0.355 },
    URP27: { x: 0.545, y: 0.063 },
    URP28: { x: 0.545, y: 0.22 },
    URP29: { x: 0.59, y: 0.22 },
    URP30: { x: 0.59, y: 0.063 },
    URP31: { x: 0.545, y: 0.015 },
    URP32: { x: 0.545, y: 0.035 },
  };
