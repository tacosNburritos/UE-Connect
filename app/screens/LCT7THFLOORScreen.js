...
const LCT7THFLOORScreen = ({ route, navigation }) => {
...
// STRICTLY FOR LABELS ONLY
  const labelNodes = {
    ...
    LB3: { x: 0.342, y: 0.201, label: "LCT 712" },
    LB4: { x: 0.342, y: 0.292, label: "LCT 710" },
    LB5: { x: 0.342, y: 0.384, label: "LCT 708" },
    LB6: { x: 0.342, y: 0.475, label: "LCT 706" },
    LB7: { x: 0.342, y: 0.566, label: "Elevator" },
    LB8: { x: 0.342, y: 0.665, label: "LCT 704" },
    LB9: { x: 0.342, y: 0.760, label: "LCT 702" },
    LB10: { x: 0.365, y: 0.845, label: "Male\n  CR" },
    LB11: { x: 0.36, y: 0.925, label: "Stairs" },

    LF1: { x: 0.540, y: 0.110, label: "LCT 713" },
    LF2: { x: 0.540, y: 0.201, label: "LCT 711" },
    LF3: { x: 0.540, y: 0.292, label: "LCT 709" },
    LF4: { x: 0.540, y: 0.384, label: "LCT 707" },
    LF5: { x: 0.540, y: 0.475, label: "LCT 705" },
  ...
  return (
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      ...
      >
        ...
        <Image
          source={require("../images/LCT7THFLR.png")}
...
export default LCT7THFLOORScreen;
